...
import profile from "../../public/Shubham .jpg";
...
const Hero = () => {
  ...
  return (
    <motion.section
      className="relative z-10 flex min-h-screen w-full items-stretch justify-center bg-[url('.//../public/hero.jpg')] bg-cover bg-center py-0 sm:h-[90vh] md:h-[100vh] 3xl:h-[85vh] overflow-x-clip"
      id="home"
      initial="initial"
      animate="animate"
    >
      ...
      >
        <motion.div
          ...
          variants={bodyAnimation}
        >
          <p className="z-50 text-center underline text-[16px] font-semibold text-[#e4ded7] md:text-[20px] lg:text-left">
